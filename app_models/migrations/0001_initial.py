# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2017-12-19 08:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_models.Lesson')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='lesson',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_models.LessonCategory'),
        ),
    ]
