...
class Lesson(models.Model):
    ...
    link2 = models.CharField(max_length=255, verbose_name='Ссылка на медиа 2', blank=True, null=True)
...
class Media(models.Model):
    ...
    link = models.CharField(max_length=255, verbose_name='Ссылка на медиа')
    date = models.DateTimeField("Дата создания", auto_now_add=True, null=True, blank=True)
